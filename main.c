...
student_record *createsr(student_record *head)
{
    ...
    {
        student_record *sr = (student_record*)malloc(sizeof(student_record));
...
assignment_record *createar(assignment_record *head)
{
    ...
    {
        assignment_record *ar = (assignment_record*)malloc(sizeof(assignment_record));
        fgets(ar->topic_name, size, fp1);
        fgets(ar->status, size, fp1);
        ar->grp_head=ar->grp_tail=NULL;
        for(int j=0; j<num_groups; j++)
        {
            struct student_group_record *sgr = (student_group_record*)malloc(sizeof(student_group_record));
...
void print_student_record(student_record *head)
{
...
void print_assignment_record(assignment_record *head)
{
    ...
    assignment_record *ar = head;
    student_group_record *sgr = ar->grp_head;
    while (ar != NULL) {
